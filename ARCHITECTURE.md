...
| `docs/usecases.md` + `docs/domain.md` | `--with-modeling` / `enable modeling` | v0.15.0 | Opt-in use-case ledger (behaviour) + domain model (structure), rendered together as a pair. Filled one feature at a time by the `model-feature` skill. See [ADR 0047](./docs/adr/0047-modeling-capability-and-per-feature-design-loop-boundary.md). |
