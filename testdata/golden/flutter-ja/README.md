...
> Flutter プロジェクトである samplekata を一行で説明する文章を記載してください。

このプロジェクトは
[aikata](https://github.com/shigindo-inc/aikata) の `flutter` プリセットで
雛形を生成しました。
...
| スタック固有ルール | [docs/stacks/flutter.md](./docs/stacks/flutter.md) |
...
aikata 自身の設定は [`.ai/aikata.yaml`](./.ai/aikata.yaml) に保存します。
