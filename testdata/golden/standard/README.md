...
> One-line description of samplekata goes here.

This project was scaffolded with
[aikata](https://github.com/shigindo-inc/aikata) — the `standard` preset.
...
```bash
# TODO: add the install / build / run instructions for samplekata
```
