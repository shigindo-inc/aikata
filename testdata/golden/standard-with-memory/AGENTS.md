...
7. [`docs/tasks/current.md`](./docs/tasks/current.md) — short-term working state
...
| Modify the public API | `SPEC.md`, `ARCHITECTURE.md`, related tests |
...
2. Check [`docs/adr/`](./docs/adr/) for past architectural decisions on
   the topic.
3. Write the question down — add it to `docs/tasks/current.md` and
