...
6. [`docs/memory/`](./docs/memory/) — 長期コンテキスト（ユーザーの好み、
   プロジェクトの覚書、参照リンク）。非自明な作業の前に
   [`feedback.md`](./docs/memory/feedback.md) を必ず確認すること。
7. [`docs/tasks/current.md`](./docs/tasks/current.md) — 短期の作業状態
...
| ユーザー／プロジェクト文脈の参照 | `docs/memory/{user,feedback,project,reference}.md` |
